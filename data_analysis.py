...
def analyze_sg_freq(file_dir_path, notedir):
    ...
    for note in note_file_name:
        ...
        for concepts in conceptlist:
            concept_cui = concepts[1]
            cui_st_list = semantic_group[concepts[1]]
...
analyze_sg_freq("data/n2c2/train_dev/dev_file_list.txt",
                "data/n2c2/train_dev/train_note/")

analyze_sg_freq("data/n2c2/test/test_file_list.txt",
                "data/n2c2/test/test_note/")
